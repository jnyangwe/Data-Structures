...
public class AsciiTrieArrayTest {

	//patricia trie
	AsciiTrieArray dict1;
	AsciiTrieArray dict2;
	AsciiTrieArray dict3;
	AsciiTrieArray dict4;
	
	
	
	@Before
	public void setUp() throws Exception {
		dict1 = new AsciiTrieArray();
		dict2 = new AsciiTrieArray();
		dict3 = new AsciiTrieArray();
		dict4 = new AsciiTrieArray();

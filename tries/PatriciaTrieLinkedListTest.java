...
public class PatriciaTrieLinkedListTest {

	//patricia trie
	PatriciaTrieLinkedList dict1;
	PatriciaTrieLinkedList dict2;
	PatriciaTrieLinkedList dict3;
	PatriciaTrieLinkedList dict4;
	
	
	
	@Before
	public void setUp() throws Exception {
		dict1 = new PatriciaTrieLinkedList();
		dict2 = new PatriciaTrieLinkedList();
		dict3 = new PatriciaTrieLinkedList();
		dict4 = new PatriciaTrieLinkedList();
	...
	public void testDelete1PA(){
		...
		assertEquals(dict1.getRoot().size(), 0);			
	}
	...
	public void testDeletePA(){
		...
		assertEquals(dict2.getRoot().size() ,1);
		dict2.delete("9647");
		assertEquals(dict2.getRoot().size() ,0);
	}
}
